...
export interface IMobileSatisfactionCardProps {}

export const MobileSatisfactionCard = (props: IMobileSatisfactionCardProps) => {
  return (
      ...
      <Container maxWidth="md">
        ...
        >
          ...
          <Stack gap={2} sx={{ position: "relative", zIndex: 1 }}>
            ...
            <Typography maxWidth="22ch" color="rgba(0, 0, 0, .6)">
